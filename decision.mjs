...
export const screening = {
  entry: {
    ...
    criteria: {
      agenda: "一个明确方向的个人行动、意愿、边界或生活立场，可明确支持什么；包括不想做某事、休息愿望、调整优先级，未说明具体方式也可以。背景提到多个候选但问句点名其中一个（如'先救猫吗'），仍是单一选择。念头不合理或冒犯不影响其作为议案。",
      ...
      multiple: "多个互相竞争的选项或多个独立的愿望，没有明确提问点名其中一个，不能确定单一表决对象。背景提到多个候选但问句只问其中一个（如'先救猫吗'），是单一选择，选agenda。",
