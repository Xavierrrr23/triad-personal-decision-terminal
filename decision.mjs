...
export const screening = {
  entry: {
    ...
    criteria: {
      ...
      emotion: "只有感受、抱怨、经历或背景,没有表达个人选择方向。特别地:想分手、想离婚、想结束一段关系,通常是情绪宣泄而非深思的决定,即使带有方向也选emotion;但当文本给出明确的事件背景(如对方家暴、出轨、背叛、长期伤害),这种关系决定是保护自己的理性选择,选agenda。想断绝联系、想断绝关系,是明确的选择,选agenda。",
